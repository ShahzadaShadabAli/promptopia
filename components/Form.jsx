        ...
        <section className="w-full max-w-full flex-start flex-col">
            ...
            <form onSubmit={handleSubmit} className="w-full mt-10 max-w-2xl flex flex-col gap-7 glassmorphism ">
                <label>
                    ...
                    <textarea required value={post.prompt} onChange={(e) => setPost({...post, prompt:e.target.value})} placeholder="Write your prompt here..." className="form_textarea"></textarea>
                </label>
                ...
                <label>
                    ...
                    <input required value={post.tag} onChange={(e) => setPost({...post, tag:e.target.value})} placeholder="#tag" className="form_input"></input>
                </label>
